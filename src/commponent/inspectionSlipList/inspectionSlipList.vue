  ...
  <div>
    ...
    >
      ...
      <el-table-column
        ...
        width='110'>
        <template slot-scope="scope">
          <span>{{scope.row.tiDd|filtersDate}}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
  ...
  export default {
    ...
    methods:{
      ...
      handleCurrentChange(data){
        ...
        axios.post(config.api, '/stock/getInspectionSlipList.do', params).then((res) => {
          console.log(res);
          if (res.status == 0) {
            ...
            if(res.data.length>0){
              ...
              console.log(this.screen_list.totalNum);
            }
          }else{
            this.$alert(res.msg, {
      ...
      enterInventory(scope){
        ...
        this.$router.push('inspectionSlipDetail')
      }
    }
  }
</script>
