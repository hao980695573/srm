      ...
      printPdf() {
        ...
        axios.post(config.api, '/barcode/updateBarcodeStatus.do', params).then((res) => {
          ...
          if (res.status == 0) {
            ...
            setTimeout(function(){
              LODOP=getLodop();
              var strStyleCSS2="<link href='../../../../static/styles/MiddlePrint.css' type='text/css' rel='stylesheet'>";
              var strFormHtml="<head>"+strStyleCSS2+"</head><body>"+document.getElementById("middlePrinting").innerHTML+"</body>";

              LODOP.ADD_PRINT_HTM("5mm","8mm","RightMargin:5cm","1200", strFormHtml);
