      ...
      printPdf() {
        ...
        axios.post(config.api, '/barcode/updateBarcodeStatus.do', params).then((res) => {
          if (res.status == 0) {
            ...
            setTimeout(function(){
              LODOP=getLodop();
              var strStyleCSS3="<link href='../../../static/styles/MiddlePrint.css' type='text/css' rel='stylesheet'>";
              var strFormHtml="<head>"+strStyleCSS3+"</head><body>"+document.getElementById("Printing").innerHTML+"</body>";
